...
public class CircleProgress extends View {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mValueWithString = typedArray.getString(R.styleable.CircleProgressBar_cp_valueString);
...
//        mSmallUnitPaint.setTypeface(Typeface.createFromAsset(mContext.getAssets(), "font/DINEngschrift-Alternate.otf"));
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mValueOffset = mCenterPoint.y + getBaselineOffsetFromY(mValuePaint) + 10;
...
//                canvas.drawText(String.format(mPrecisionFormat, mValue), mCenterPoint.x, mValueOffset, mValuePaint);
    ...
    public void setBgArcColor(@ColorInt int color) {
        this.mBgArcColor = color;
        mBgArcPaint.setColor(color);
    }

    public void setBgArcWidth(int mBgArcWidth) {
        this.mBgArcWidth = mBgArcWidth;
        mBgArcPaint.setStrokeWidth(mBgArcWidth);
    }
